...
def load_mpds_manifestos(country_code: str, party_ids: list[int]) -> pd.DataFrame:
    ...
    manifestos_df["manifesto_date_basis"] = "MPDS edate (election date)"
    ...
    manifestos_df.loc[
        missing_effective_mask, "manifesto_date_basis"
    ] = "MPDS YYYYMM month-start fallback (election month)"
