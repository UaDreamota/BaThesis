"""Build the speech-party to Manifesto Project party mapping.

Despite the former filename, this module does not fit an LDA model.  It is a
data-preparation stage used by the manifesto and PLDA pipelines.
"""
...
UKRAINE_MAPPING_PATH = OUTPUT_DIR / "UA_party_mapping_speech_to_mpds.csv"
UKRAINE_NOT_IN_MPDS_PATH = OUTPUT_DIR / "UA_labels_not_in_mpds.csv"
UKRAINE_NOT_IN_MPDS_PARTIES_PATH = OUTPUT_DIR / "UA_real_parties_not_in_mpds.csv"
UKRAINE_NOT_IN_MPDS_PARLIAMENTARY_PATH = (
    OUTPUT_DIR / "UA_parliamentary_labels_not_in_mpds.csv"
)
